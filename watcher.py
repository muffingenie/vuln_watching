...
def send_email(subject, body, recipient):
    sender_email = "cti_tracker@zohomail.com"
    sender_password = "muaJc5H1zTM1"  # Remplace par ton mot de passe sécurisé
...
def main():
    ...
    send_email("Daily Cybersecurity Report", email_content, "lucien.lagarde@gmail.co
import requests
import feedparser
import json
import smtplib
...
def main():
    ...
    email_content = format_email_content(nvd_cves, mitre_cves, cisa_cves, articles)
    send_email("Daily Cybersecurity Report", email_content, "lucien.lagarde@gmail.com
import requests
import feedparser
import json
import smtplib
...
def send_email(subject, body, recipient):
    sender_email = "CHANGE_ME" SENDER EMAIL 
    sender_password = "CHANGE_ME"  # SENDER EMAIL PASSWORD
